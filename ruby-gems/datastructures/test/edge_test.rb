...
class EdgeTest < MiniTest::Unit::TestCase
  def test_compare
    edge1 = DataStructures::Graph::Edge.new([1, 1],  [2, 1])
    edge2 = DataStructures::Graph::Edge.new([1, 1],  [2, 1])
    edge3 = DataStructures::Graph::Edge.new([1, 1],  [2, 1], 2)
    edge4 = DataStructures::Graph::Edge.new([3, 1],  [5, 1], 2)
  ...
  def test_weight
    edge1 = DataStructures::Graph::Edge.new([1, 1],  [2, 1])
    edge2 = DataStructures::Graph::Edge.new([1, 1],  [3, 1], 3)
