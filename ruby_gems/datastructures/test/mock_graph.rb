...
class MockGraph
  ...
  def initialize()
    ...
    vertex2 = DataStructures::Components::Vertex.new([0, 5], edge4, edge9)
    vertex3 = DataStructures::Components::Vertex.new([5, 0], edge5, edge3)
    vertex4 = DataStructures::Components::Vertex.new([7, 0], edge6, edge7)
    vertex5 = DataStructures::Components::Vertex.new([7, 5], edge8, edge10)
